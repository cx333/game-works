...
const file_auth_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"auth.proto\x12\x04auth\"\xb4\x01\n" +
	"\vAuthMessage\x12#\n" +
	"\x04type\x18\x01 \x01(\x0e2\x0f.auth.LoginTypeR\x04type\x12\x17\n" +
...
var file_auth_proto_goTypes = []any{
	...
	(*AuthMessage)(nil),     // 1: auth.AuthMessage
	(*AuthResult)(nil),      // 2: auth.AuthResult
	(*RegisterMessage)(nil), // 3: auth.RegisterMessage
	(*RegisterResult)(nil),  // 4: auth.RegisterResult
}
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthMessage.type:type_name -> auth.LoginType
