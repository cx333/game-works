...
func (x *GatewayMessage) GetCmd() int32 {
	if x != nil {
		return x.Cmd
	}
	return 0
...
func (x *GatewayMessage) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
const file_gateway_proto_rawDesc = "" +
	"\n" +
	"\rgateway.proto\x12\x05proto\"<\n" +
	"\x0eGatewayMessage\x12\x10\n" +
	"\x03cmd\x18\x01 \x01(\x05R\x03cmd\x12\x18\n" +
	"\apayload\x18\x02 \x01(\fR\apayloadB*Z(github.com/cx333/pkg/proto/gateway.protob\x06proto3"
